      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav">
          ...
          <li
            className={"nav-item"}
          >
            <Link href="/#affiliates" role="button" className="nav-link">
              Affiliates
            </Link>
          </li>
          ...
          <li
            className={"nav-item"}
          >
            <Link href="/#advertisers" role="button" className="nav-link">
              Advertisers
            </Link>
          </li>
          ...
          <li
            className={"nav-item"}
          >
            <Link href="/#contact-us" role="button" className="nav-link">
              Contact Us
            </Link>
          </li>
