  ...
  return (
    ...
    --> */}
      ...
      {/* 
        ...
        ============================================== 
        */}
      <div id="advertisers" className="fancy-feature-thirtyTwo mt-190 lg-mt-120">
        <div className="container">
          <div className="row">
            <FeaturesBlock />
          </div>
          ...
          <div className="row">
            <div className="col-lg-6 col-md-7 ms-lg-auto" data-aos="fade-left">
              <div className="title-style-ten">
                <div className="sc-title">Payment methods</div>
                <h2 className="main-title font-recoleta fw-normal tx-dark">
                  Crypto | Wire | Paxum
                </h2>
              </div>
        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-8 m-auto text-center">
              ...
              <Link
                href="mailto:info@smagency.info"
          ...
          <div className="container">
            <div className="row justify-content-between">
              <div className="col-lg-2 footer-intro mb-40">
                <div className="logo">
                  <Link href="/">
                    <img src="/images/logo/logo_transparent.png" alt="" width={250} />
                  </Link>
                </div>
              </div>
              <FooterContent />
